...
class wbatParams(): # daft/wbat metadata
    mooringNum = 4 # mooring id number
...
class evParams(): # Echoview specific needs
    ...
    numFiles = [0]#range(7,40) # number of files to create.  if '0', create ALL
    dataDir = 'E:\\MooredEchosounders\\data\\2019\\WBAT1\\' # directory of *.raw data
    outputDir = 'E:\\MooredEchosounders\\data\\2019\\EvFiles\\DAFT1\\' # directory for created EV files
