...
class wbatParams(): # daft/wbat metadata
    mooringNum = 2 # mooring id number
    ...
    mooringLoc = [70.8357, -163.1044] # DAFT deployment location
    mooringCompassOffset = 208
    mooringMagDec = 11.6
...
class evParams(): # Echoview specific needs
    ...
    dataDir = 'E:\\MooredEchosounders\\data\\2018\\WBAT2\\' # directory of *.raw data
    outputDir = 'E:\\MooredEchosounders\\data\\2018\\EVFiles\\DAFT2\\' # directory for created EV files
